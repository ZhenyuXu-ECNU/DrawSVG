...
class SoftwareRendererImp : public SoftwareRenderer {
 ...
 private:
  ...
  // rasterize line by Bresenham algorithm
  // only rasterize line in octant 0, 3, 4 and 7
  void rasterize_line_bresenham_low_slope(float x0, float y0,
                                          float x1, float y1,
                                          Color& color);

  // rasterize line by Bresenham algorithm
  // only rasterize line in octant 0, 3, 4 and 7
  void rasterize_line_bresenham_high_slope(float x0, float y0,
                                           float x1, float y1,
                                           Color& color);
  ...
  // TODO: implement Xiaolin Wu's line algorithm with antialiasing
